...
[Files]
; 主程序（单文件）
Source: "..\build\RFID-WMS.exe";          DestDir: "{app}";                     Flags: ignoreversion

; 配置 & 启动脚本（安装时由 [Code] 动态写入）
Source: "..\build\config.ini";           DestDir: "{app}";                     Flags: ignoreversion
Source: "..\build\start.bat";            DestDir: "{app}";                     Flags: ignoreversion
Source: "..\build\stop.bat";             DestDir: "{app}";                     Flags: ignoreversion
Source: "..\build\uninstall-firewall.bat"; DestDir: "{app}";                  Flags: ignoreversion

; 前端页面
Source: "..\build\web\*";                DestDir: "{app}\web";                  Flags: ignoreversion recursesubdirs createallsubdirs

; 运行时目录
Source: "..\build\data\*";                DestDir: "{app}\data";                 Flags: ignoreversion recursesubdirs createallsubdirs; Permissions: users-modify
Source: "..\build\logs\*";               DestDir: "{app}\logs";                 Flags: ignoreversion recursesubdirs createallsubdirs
Source: "..\build\scan_files\*";         DestDir: "{app}\scan_files";           Flags: ignoreversion recursesubdirs createallsubdirs
Source: "..\build\exports\*";           DestDir: "{app}\exports";              Flags: ignoreversion recursesubdirs createallsubdirs
Source: "..\build\uploads\*";            DestDir: "{app}\uploads";              Flags: ignoreversion recursesubdirs createallsubdirs
...
; Android APK（如有）
Source: "..\build\public\*";             DestDir: "{app}\public";               Flags: ignoreversion recursesubdirs createallsubdirs skipifsourcedoesntexist
...
begin
  ...
  begin
    ...
    begin
      Exec('netsh',
           'advfirewall firewall add rule name="RFID WMS ' + SavedPort +
